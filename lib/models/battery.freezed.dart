...
@JsonKey(readValue: _readTagName) String get tagName;/// 電池型號
 ...
 String? get currentPackageId;/// 自訂欄位
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,documentId,serialNumber,tagName,batteryModel,purchaseDate,cycleCount,healthStatus,currentPackageId,const DeepCollectionEquality().hash(customFields),isDeleted);

@override
String toString() {
  return 'Battery(documentId: $documentId, serialNumber: $serialNumber, tagName: $tagName, batteryModel: $batteryModel, purchaseDate: $purchaseDate, cycleCount: $cycleCount, healthStatus: $healthStatus, currentPackageId: $currentPackageId, customFields: $customFields, isDeleted: $isDeleted)';
}
...
@useResult
$Res call({
 String documentId, String? serialNumber,@JsonKey(readValue: _readTagName) String tagName, String batteryModel, DateTime? purchaseDate, int cycleCount, String healthStatus, String? currentPackageId, Map<String, String> customFields, bool isDeleted
});
...
/// Create a copy of Battery
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? documentId = null,Object? serialNumber = freezed,Object? tagName = null,Object? batteryModel = null,Object? purchaseDate = freezed,Object? cycleCount = null,Object? healthStatus = null,Object? currentPackageId = freezed,Object? customFields = null,Object? isDeleted = null,}) {
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String documentId,  String? serialNumber, @JsonKey(readValue: _readTagName)  String tagName,  String batteryModel,  DateTime? purchaseDate,  int cycleCount,  String healthStatus,  String? currentPackageId,  Map<String, String> customFields,  bool isDeleted)  $default,) {final _that = this;
switch (_that) {
case _Battery():
return $default(_that.documentId,_that.serialNumber,_that.tagName,_that.batteryModel,_that.purchaseDate,_that.cycleCount,_that.healthStatus,_that.currentPackageId,_that.customFields,_that.isDeleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String documentId,  String? serialNumber, @JsonKey(readValue: _readTagName)  String tagName,  String batteryModel,  DateTime? purchaseDate,  int cycleCount,  String healthStatus,  String? currentPackageId,  Map<String, String> customFields,  bool isDeleted)?  $default,) {final _that = this;
switch (_that) {
case _Battery() when $default != null:
return $default(_that.documentId,_that.serialNumber,_that.tagName,_that.batteryModel,_that.purchaseDate,_that.cycleCount,_that.healthStatus,_that.currentPackageId,_that.customFields,_that.isDeleted);case _:
  return null;
...
class _Battery implements Battery {
  const _Battery({required this.documentId, this.serialNumber, @JsonKey(readValue: _readTagName) required this.tagName, required this.batteryModel, this.purchaseDate, required this.cycleCount, required this.healthStatus, this.currentPackageId, final  Map<String, String> customFields = const {}, this.isDeleted = false}): _customFields = customFields;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,documentId,serialNumber,tagName,batteryModel,purchaseDate,cycleCount,healthStatus,currentPackageId,const DeepCollectionEquality().hash(_customFields),isDeleted);
...
/// Create a copy of Battery
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? documentId = null,Object? serialNumber = freezed,Object? tagName = null,Object? batteryModel = null,Object? purchaseDate = freezed,Object? cycleCount = null,Object? healthStatus = null,Object? currentPackageId = freezed,Object? customFields = null,Object? isDeleted = null,}) {
